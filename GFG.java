...
// Source: http://www.geeksforgeeks.org/number-distinct-permutation-string-can/
...
public class GFG {
    ...
    public static void main(String args[])
    {
        // String str = "sotong";
        String str = args[0];
        System.out.println("The number of possible permutations for '" + str + "' is " + countDistinctPermutations(str));
    }
}
